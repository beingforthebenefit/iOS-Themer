        <div class="form-iphone-switch">
            ...
            <p class="app-label-edit-note">Tip: Click an icon label to edit it</p>
        </div>
        ...
        <form method="post" action="/">
            <input type="hidden" name="a" value="clearAllLabels" />
            <div class="form-button-wrap clear-labels">
                <input type="submit" class="form-field-button" value="Clear All Labels" />
            </div>
        </form>
        <div class="iphone">
