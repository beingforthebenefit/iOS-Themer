    ...
    <footer class="footer">
        <div class="footer-row">
            <div class="footer-note">
                <p class="contact">Made with ❤ by <a href="https://github.com/beingforthebenefit" target="_BLANK">Gerald Todd</a> and <a href="https://twitter.com/ubaidafedar" target="_BLANK">Ubaid D.</a></p>
            </div>
            <div class="footer-note">
